...
faqs: [
    ...
    { question: 'Quanto custa limpar um tapete profissionalmente?', answer: 'A limpeza profissional de tapetes é sempre orçamentada à medida: cada peça é medida individualmente (largura × comprimento) e o preço depende do tipo de fibra, dimensão e estado de sujidade, sem tabela fixa por m².', link: { label: 'Pedir orçamento para limpeza de tapetes', href: 'https://wa.me/351920320174?text=Ol%C3%A1!%20Gostaria%20de%20pedir%20um%20or%C3%A7amento%20para%20limpeza%20de%20tapetes.' } },
    { question: 'Qual é a diferença entre tapete e alcatifa para efeitos de limpeza?', answer: 'O tapete é uma peça solta que pode ser movida ou transportada. A alcatifa é um revestimento de piso fixo que cobre toda uma divisão. Os tapetes avulsos são tratados ao domicílio ou com recolha/entrega; as alcatifas são sempre limpas no local por extração a vapor. Em ambos os casos, o orçamento é sempre feito à medida.' },
